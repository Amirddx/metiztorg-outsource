    ...
    public function getVacancies() {
        ...
        try {
            ...
            $columns = [
                ...
                'Position'=>'E',// на должность
                'Status' => 'F', // статус вакансии
                'Headcount' => 'G', // Кол-во вакансий
                'District' => 'H', // Район/метро
                'Address' => 'I', // полный адрес
                'HourlyPay' => 'J', // ставка за час
                'OrderPay' => 'K', // оплата за каждый заказ
                'ShiftPay' => 'L', // Ср. доход за смену
                'Slots' => 'M', // Слоты (график работы)
                'Promotions' => 'P', // Акции
