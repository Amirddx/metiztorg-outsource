    ...
    <section class="row justify-content-center mb-5">
        <div class="col-lg-10 text-center">
            ...
            <div class="mt-4">
                ...
                <p class="text-muted mt-3">После заполнения анкеты жди звонка от нашего менеджера — твоя первая смена уже на подходе!</p>
            </div>
            <!-- Обновлённый блок "Процесс трудоустройства онлайн" -->
            <div class="mt-5 bg-light p-4 rounded-3 shadow-sm">
                ...
                <div class="accordion" id="hiringProcess">
                    <div class="accordion-item border-0">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#hiringProcess">
                            <div class="accordion-body text-muted">
                                Ты заполняешь анкету и загружаешь документы — они моментально поступают в наш отдел кадров.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item border-0">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#hiringProcess">
                            <div class="accordion-body text-muted">
                    ...
                    <div class="accordion-item border-0">
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#hiringProcess">
                            <div class="accordion-body text-muted">
                                Наш менеджер позвонит, чтобы согласовать удобное время твоей первой смены и адрес — выбирай из <a href="/jobs.php" class="text-decoration-underline text-dark">открытых вакансий на карте</a>!
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item border-0">
                        ...
                        <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#hiringProcess">
                            <div class="accordion-body text-muted">
