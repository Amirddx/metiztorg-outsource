...
<section class="hero position-relative text-white" id="hero">
    <div class="videoWrapper">
        <video autoplay loop muted class="custom-video" poster="/assets/images/140_02.jpg">
            <source src="/assets/videos/mixkit-banknotes-falling-on-a-dark-background-18305-ful-hd.mp4" type="video/mp4">
